...
Primitive fitting from user strokes is a non-trivial task, especially the roughness of the user drawn will greatly affects the fitting quality. We thus resort to the Transformer to help suggest the primitive type, pose, shape, etc. as the starting point and apply the 2D-3D registration algorithm to get the resulting shape faithfully.
